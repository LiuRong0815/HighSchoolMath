...
for num in range(0,texFileNum):
    ...
    for oneline in lines:
        ...
        # subproblem
        oneline = oneline.replace('\\begin{subproblem}', '')
        oneline = oneline.replace('\\end{subproblem}', '')
        
        # twocolpro
        oneline = oneline.replace('\\begin{twocolpro}', '')
        oneline = oneline.replace('\\end{twocolpro}', '')
        
        # threecolpro
        oneline = oneline.replace('\\begin{threecolpro}', '')
        oneline = oneline.replace('\\end{threecolpro}', '')
                
        # fourcolpro
        oneline = oneline.replace('\\begin{fourcolpro}', '')
        oneline = oneline.replace('\\end{fourcolpro}', '')
